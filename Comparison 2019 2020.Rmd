...
```{r}
plot1 <- barplot(comp_perc_ALL$perc_diff ~ comp_perc_ALL$country, col = c("skyblue"), las = 2, cex.names = 1, xlab = NA, ylab = "Change in Percentage Notification", cex.axis = par(0.2))
```
