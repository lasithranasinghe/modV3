...
gg_incl04 <- ggplot(incl_case2, aes(x = g_whoregion, y = est_value, color = est)) + geom_boxplot() + geom_point(aes(x = g_whoregion, y = case_value, color = case)) + facet_wrap(~incl_case2$sex)
...
gg_incl514 <- ggplot(incl_case5142, aes(x = g_whoregion, y = est_value, color = est)) + geom_boxplot() + geom_point(aes(x = g_whoregion, y = case_value, color = case)) + facet_wrap(~incl_case5142$sex)
...
gg_incl15plus <- ggplot(incl_case15plus2, aes(x = g_whoregion, y = est_value, color = est)) + geom_boxplot() + geom_point(aes(x = g_whoregion, y = case_value, color = case)) + facet_wrap(~incl_case15plus2$sex)
