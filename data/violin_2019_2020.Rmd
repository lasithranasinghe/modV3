...
box_f04 <- boxplot(value ~ country, iisubpiv_f04, horizontal = TRUE)
...
box_m014 <- boxplot(value ~ country, iisubpiv_m014, horizontal = TRUE)
...
box_f014 <- boxplot(value ~ country, iisubpiv_f014, horizontal = TRUE)
...
box_m15plus <- boxplot(value ~ country, iisubpiv_m15plus, horizontal = TRUE)
...
box_f15plus <- boxplot(value ~ country, iisubpiv_f15plus, horizontal = TRUE)
