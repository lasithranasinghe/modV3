...
afr_04 <- afr_04[c(2,1), -8]
afr_04 %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,30000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for Ages 0-4 Years in AFR")
...
amr_04 <- amr_04[c(2,1), -8]
amr_04 %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,3000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for Ages 0-4 Years in AMR")
...
emr_04 <- emr_04[c(2,1), -8]
emr_04 %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,20000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for Ages 0-4 Years in EMR")
...
eur_04 <- eur_04[c(2,1), -8]
eur_04 %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,3000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for Ages 0-4 Years in EUR")
...
sea_04 <- sea_04[c(2,1), -8]
sea_04 %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,60000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for Ages 0-4 Years in SEA")
...
wpr_04 <- wpr_04[c(2,1), -8]
wpr_04 %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,20000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for Ages 0-4 Years in WPR")
...
afr_514 <- afr_514[c(2,1), -8]
afr_514 %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,40000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for ages 5-14 Years in AFR")
...
amr_514 <- amr_514[c(2,1), -8]
amr_514 %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,4000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for ages 5-14 Years in AMR")
...
emr_514 <- emr_514[c(2,1), -8]
emr_514 %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,30000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for ages 5-14 Years in EMR")
...
eur_514 <- eur_514[c(2,1), -8]
eur_514 %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,5000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for ages 5-14 Years in EUR")
...
sea_514 <- sea_514[c(2,1), -8]
sea_514 %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,100000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for ages 5-14 Years in SEA")
...
wpr_514 <- wpr_514[c(2,1), -8]
wpr_514 %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,30000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for ages 5-14 Years in WPR")
```
...
afr_15plus <- afr_15plus[c(2,1), -8]
afr_15plus %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,1000000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for ages 15plus Years in AFR")
...
amr_15plus <- amr_15plus[c(2,1), -8]
amr_15plus %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,300000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for ages 15 plus Years in AMR")
...
emr_15plus <- emr_15plus[c(2,1), -8]
emr_15plus %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,300000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for ages 15plus Years in EMR")
...
eur_15plus <- eur_15plus[c(2,1), -8]
eur_15plus %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,200000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for ages 15plus Years in EUR")
...
sea_15plus <- sea_15plus[c(2,1), -8]
sea_15plus %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,2000000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for ages 15plus Years in SEA")
...
wpr_15plus <- wpr_15plus[c(2,1), -8]
wpr_15plus %<>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,1000000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for ages 15plus Years in WPR")
```
...
mf_plot <- mf_years %>% barplot(col = c("seagreen1", "skyblue"), beside = TRUE, ylim = c(0,5000000), xlab = "Year", ylab = "Notifications") + title("Sex Disaggregated Notifications for All Ages Globally")
...
#AFR
afr_sed <- cbind(rownames(afr_estimates), afr_estimates)
...
#AMR
amr_sed <- cbind(rownames(amr_estimates), amr_estimates)
...
#EMR
emr_sed <- cbind(rownames(emr_estimates), emr_estimates)
...
#EUR
eur_sed <- cbind(rownames(eur_estimates), eur_estimates)
...
#SEA
sea_sed <- cbind(rownames(sea_estimates), sea_estimates)
...
#WPR
wpr_sed <- cbind(rownames(wpr_estimates), wpr_estimates)
