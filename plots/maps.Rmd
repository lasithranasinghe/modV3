...
The `percent_change` variable represents the 2020 notifications divided by 2019 notifications.
Therefore, values less than 1 represent a drop in notifications while values greater than 1
signify an increase.

```{r}
save(mpd, file = here('plots/mpd.Rdata'))
```
